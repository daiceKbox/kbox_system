                ...
                <tbody>
                    <tr data-row_index="{{ data_get($company,"row_index") }}" data-name="{{ data_get($company,"company_name") }}" data-kana="{{ data_get($company,"kana") }}">
                        ...
                        <td class="companies-show-table-address">
                            ...
                            <dl>
                                <dd class="companies-show-table-address-tel">{{ data_get($company, "contact.tel") }}</dd>
                                <dd class="companies-show-table-address-fax">{{ data_get($company, "contact.fax") }}</dd>
                            </dl>
                        </td>
                ...
                <table id="companies-company_products-table">
                    <thead>
                        <tr>
                            ...
                            <th class="companies-company_products-table-date">納期</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="companies-company_products-table-date">
                                <input
                                    class="companies-company_products-table-date-input"
                                    type="date"
                                    name="{{ $base_name }}[date]"
